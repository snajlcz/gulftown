...
enum CharacterDatabaseStatements
{
    ...
    */
    ...
    // CUSTOM
    CHAR_DEL_CHARACTER_ADDON,
    CHAR_SEL_MAIL_ACCOUNTWIDE,
    CHAR_SEL_CHARACTER_MAILCOUNT_ACCOUNTWIDE,
    CHAR_SEL_CHARACTER_MAILDATE_ACCOUNTWIDE,
    CHAR_SEL_CHAR_LIST_INVENTORY_COUNT_ITEM,
    CHAR_SEL_CHAR_LIST_INVENTORY_ITEM_BY_ENTRY,
